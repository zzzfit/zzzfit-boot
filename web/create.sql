...
create table alliance (deleted boolean, created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, description varchar(255), primary key (id));
...
create table authority (deleted boolean, created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, name varchar(63) not null unique, description varchar(255), primary key (id));
...
create table dian (business_hour_end time(6), business_hour_start time(6), deleted boolean, shop_area float(24), status tinyint check (status between 0 and 3), created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, name varchar(63) not null, description varchar(255), equipment_info varchar(255), primary key (id));
create table franchisee (deleted boolean, created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, description varchar(255), primary key (id));
create table invitation (deleted boolean, when time(6) not null, created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, description varchar(255), primary key (id));
...
create table organization (deleted boolean, created_at timestamp(6), created_by bigint, id bigint not null, owned_by bigint not null, parent_id bigint, updated_at timestamp(6), updated_by bigint, name varchar(63) not null unique, description varchar(255), primary key (id));
create table payment (id bigint not null, primary key (id));
create table role (deleted boolean, created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, name varchar(63) not null unique, description varchar(255), primary key (id));
create table role_authority (authority_id bigint not null, role_id bigint not null, primary key (authority_id, role_id));
create table tutorial (id bigint not null, primary key (id));
create table user (birthday date, deleted boolean, gender tinyint check (gender between 0 and 1), created_at timestamp(6), created_by bigint, id bigint not null, updated_at timestamp(6), updated_by bigint, email varchar(31) unique, mobile varchar(31) unique, type varchar(31) not null, nickname varchar(63), username varchar(63) not null unique, avatar_url varchar(255), coach_id varchar(255), description varchar(255), member_id varchar(255), password varchar(255), store_id varchar(255), primary key (id));
